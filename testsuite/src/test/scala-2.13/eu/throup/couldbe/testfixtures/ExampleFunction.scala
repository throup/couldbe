...
object ExampleFunction {
  def simpleGivenParameter(implicit message: CouldBeGiven[String]): String = message match {
  ...
  def willFailIfNotOne[F[_] : Monad](n: Int)(implicit MT: CouldBe[MonadThrow, F], MSF: CouldBe[MonadStringFailure, F], MSS: CouldBe[MonadSilentFailure, F]): F[String] = {
